...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'NewResultView',
          path: '/newResultView',
          builder: (context, params) => NewResultViewWidget(
            name: params.getParam(
              'name',
              ParamType.String,
            ),
            sciName: params.getParam(
              'sciName',
              ParamType.String,
            ),
            ...
            chemControl: params.getParam(
              'chemControl',
              ParamType.String,
            ),
            natControl: params.getParam(
              'natControl',
              ParamType.String,
            ),
